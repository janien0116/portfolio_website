...
import { Button, Container, Form, Stack, Modal } from "react-bootstrap";
    ...
    <div>
      <Container className="py-5">
        ...
        <p className="text-center fs-6 text-white">
          Get in touch with me to discuss how I can bring my web development
        ...
        >
          <p>
            <i class="bi bi-envelope-at"></i> daculongjanela31@gmail.com
          </p>
          <p>
            <i className="bi bi-linkedin"></i> Janela Daculong
          </p>
          <p>
            <i class="bi bi-messenger"></i> Janela Daculong
          </p>
        </Stack>
        <p className="fw-bold fs-5 text-white text-center mt-4">
          Send me an email
        </p>
        {isEmailNotSent && (
        ...
        <Container className="glass2 mb-5">
          <Form ref={form} onSubmit={sendEmail}>
            ...
            <div className="text-center">
              <Button
                type="submit"
                className="px-5 rounded-pill fs-5 border border-2"
              >
                Send
              </Button>
            </div>
        ...
        <Modal show={showDialog} onHide={handleCloseDialog}>
          ...
          <Modal.Body>
            Thank you for reaching out to me! I sincerely appreciate your email.
            I will carefully review your company and its offerings. Thank you once again. <i class="bi bi-emoji-smile"></i>
          </Modal.Body>
          <Modal.Footer>
